...
const { submitLeave, updateLeaveStatus,getStudentLeaves,getCoordinatorLeaves,getHODLeaves,getLeaveById,getLeaveHistory,getLeaveStats,getLeavesByDate ,deleteLeave} = require('../controllers/leaveController');
